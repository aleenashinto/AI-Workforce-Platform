      ...
      >
        ...
        {sent ? (
          <div style={{ marginTop: "2rem", textAlign: "center" }}>
            <div style={{ fontSize: "3rem", color: T.g, marginBottom: "1rem" }}>
              ✓
            </div>
            <p
              style={{
            ...
            >
              A password recovery signal has been transmitted to{" "}
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              Enter the email address associated with your terminal access.
