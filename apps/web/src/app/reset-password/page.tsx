            ...
            >
              ...
              <div
                style={{
                  ...
                  fontFamily: T.mono,
                  fontSize: "0.75rem",
                  color: reqs.special ? T.g : T.muted,
                }}
              >
...
export default function ResetPasswordPage() {
  return (
    <Suspense
      fallback={
        <div style={{ minHeight: "100vh", background: T.bg, color: T.g }}>
          Loading...
        </div>
      }
    >
