...
function VerifyContent() {
  ...
  const [status, setStatus] = useState<"waiting" | "verified" | "expired">(
    "waiting",
  );
    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: "2rem" }}>
          ...
          >
            {status === "waiting" &&
              (token ? "Verifying..." : "Verify your email")}
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                gap: "0.5rem",
                transition:
                  "box-shadow 0.2s, background 0.2s, border-color 0.2s",
        ...
        {status === "expired" && (
          ...
          >
            ...
            <button
              ...
              onMouseEnter={(e) => {
                if (!isResending) {
                  e.currentTarget.style.boxShadow = `0 0 20px ${T.warn}55`;
                  e.currentTarget.style.background = "#ffcc33";
                }
              }}
              onMouseLeave={(e) => {
                if (!isResending) {
                  e.currentTarget.style.boxShadow = "";
                  e.currentTarget.style.background = T.warn;
                }
              }}
            >
              <RefreshCw
