    ...
    <div className="p-8 h-full overflow-y-auto bg-[#040810]">
      ...
      <div className="flex justify-between items-center mb-8 flex-wrap gap-4">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="bg-[#0a1628] text-gray-300 border border-gray-700 px-4 py-2 rounded font-mono text-sm hover:bg-gray-800 transition-colors flex items-center gap-2"
          >
      ...
      <div className="grid grid-cols-4 gap-4 mb-8 font-mono">
        {[
          ...
          <div
            key={label}
            className={`bg-[#0a1628] border ${border} p-4 rounded-lg text-center`}
          >
      ...
      <div className="bg-[#0a1628] border border-[#00ff88]/20 rounded-lg overflow-hidden flex flex-col min-h-[500px]">
        {/* Filter bar */}
        <div className="p-4 border-b border-[#00ff88]/10 flex flex-wrap gap-3 items-center bg-[#070e1a]">
          {/* Search */}
            ...
            <div className="flex flex-col gap-4">
              {[
                ...
                <button
                  ...
                  disabled={connecting}
                  className="flex items-center justify-between p-4 border border-gray-700 hover:border-[#00ff88]/50 rounded-lg bg-[#040810] transition-colors group disabled:opacity-50 disabled:cursor-not-allowed"
                >
