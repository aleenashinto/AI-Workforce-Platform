...
export default function SequencesPage() {
  ...
  return (
    <div className="p-8 h-full overflow-y-auto bg-[color:var(--t-bg)]">
      ...
      <div className="bg-[color:var(--t-panel)] rounded-xl border border-[#00ff88]/20 overflow-hidden flex flex-col h-[calc(100vh-300px)]">
        <div className="p-4 border-b border-[#00ff88]/20 flex justify-between items-center bg-[color:var(--t-bg)]">
