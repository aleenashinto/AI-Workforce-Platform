    ...
    >
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-4 items-center justify-between">
        <div className="relative w-full md:w-96">
          ...
          <input
            ...
            className="w-full bg-[color:var(--t-panel)] border border-[rgba(0,207,255,0.2)] rounded-lg pl-9 pr-4 py-2 text-white outline-none focus:border-[#00cfff] transition-colors"
          />
        </div>
        <div className="flex gap-3 w-full md:w-auto">
          <select
            ...
            className="bg-[color:var(--t-panel)] border border-[rgba(0,255,136,0.2)] text-[#00ff88] rounded-lg px-3 py-2 outline-none font-bold text-sm uppercase tracking-wider"
          >
          ...
          <select
            ...
            className="bg-[color:var(--t-panel)] border border-[rgba(0,207,255,0.2)] text-[#00cfff] rounded-lg px-3 py-2 outline-none font-bold text-sm uppercase tracking-wider"
          >
      ...
      {selectedLead && (
        <div className="fixed inset-0 z-50 flex justify-end bg-black/60 backdrop-blur-sm animate-in fade-in">
          <div className="w-full md:w-[600px] h-full bg-[color:var(--t-bg2)] border-l border-[rgba(0,255,136,0.3)] shadow-2xl flex flex-col animate-in slide-in-from-right overflow-hidden">
            {/* Header */}
            <div className="p-6 border-b border-[rgba(0,255,136,0.2)] bg-[color:var(--t-panel)] flex-shrink-0">
            ...
            {/* Footer Actions */}
            <div className="p-6 border-t border-[rgba(0,255,136,0.2)] bg-[color:var(--t-panel)] flex gap-3">
