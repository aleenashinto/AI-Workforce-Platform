    ...
    <div className="p-4 md:p-8 max-w-[1400px] mx-auto w-full min-h-screen">
      ...
      <div className="mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="font-mono text-sm text-[#351c75] tracking-wide">
        ...
        <div className="flex flex-wrap gap-3 items-center">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none bg-[color:var(--t-panel)] border border-[rgba(0,207,255,0.3)] text-[color:var(--t-text)] font-mono text-xs px-4 py-2 pr-8 outline-none cursor-pointer hover:border-[#00cfff] transition-colors"
            >
              {[
                "Today",
                "Yesterday",
          ...
          <button
            onClick={() => router.push("/sales-assistant/leads")}
            className="flex items-center gap-2 bg-[#00cfff] text-[color:var(--t-bg)] border-none font-mono text-xs px-4 py-2 uppercase font-bold"
            style={{
              clipPath:
      ...
      {error ? (
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 relative bg-[color:var(--t-panel)] border border-[rgba(0,207,255,0.18)] p-6">
              <Corners />
                  ...
                  return (
                    ...
                    >
                      <div
                        ...
                        style={{ height }}
                      >
                        <div className="absolute -top-8 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 font-mono text-xs text-[#00cfff] bg-[color:var(--t-bg)] border border-[#00cfff] px-2 py-1 z-10 whitespace-nowrap pointer-events-none transition-opacity">
                          {val} {chartFilter}
                        </div>
                      </div>
            ...
            <div className="lg:col-span-1 relative bg-[color:var(--t-panel)] border border-[rgba(0,255,136,0.3)] p-6 shadow-[0_0_15px_rgba(0,255,136,0.05)]">
              <Corners />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* Pipeline Stages */}
            <div className="relative bg-[color:var(--t-panel)] border border-[rgba(0,207,255,0.18)] p-6 overflow-hidden">
              <Corners />
            ...
            {/* Lead Funnel */}
            <div className="relative bg-[color:var(--t-panel)] border border-[rgba(0,207,255,0.18)] p-6">
              <Corners />
              <div className="font-mono text-sm text-[rgba(0,207,255,0.5)] tracking-widest uppercase mb-6">
                Lead Funnel
              </div>
              <div className="flex items-stretch justify-center h-[280px] gap-1 px-4">
                {data.funnel.map((s, i, arr) => (
                  <div key={i} className="flex-1 flex flex-col items-center">
                    ...
                    >
                      {i < arr.length - 1 && (
                        <div className="absolute -right-3 top-1/2 -translate-y-1/2 text-[rgba(0,207,255,0.5)] z-10 text-[10px] bg-[color:var(--t-bg)] border border-[rgba(0,207,255,0.3)] rounded-full w-6 h-6 flex items-center justify-center">
                          {s.dropoffPercent}%
                        </div>
                      )}
                    </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="relative bg-[color:var(--t-panel)] border border-[rgba(0,255,136,0.3)] p-6 shadow-[0_0_15px_rgba(0,255,136,0.05)]">
              <Corners />
              <div className="font-mono text-sm text-[#00ff88] tracking-widest uppercase mb-6 flex items-center gap-2">
          ...
          {/* RECENT LEADS TABLE */}
          <div className="relative bg-[color:var(--t-panel)] border border-[rgba(0,207,255,0.18)] p-6 overflow-x-auto">
            <Corners />
              ...
              <div className="flex gap-2">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="bg-[rgba(0,207,255,0.05)] border border-[rgba(0,207,255,0.2)] text-[color:var(--t-text)] font-mono text-xs pl-8 pr-3 py-1.5 outline-none focus:border-[#00cfff] w-48"
                  />
                </div>
                <div className="relative">
                  <Filter
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="relative bg-[color:var(--t-panel)] border border-[rgba(0,207,255,0.18)] p-5 flex flex-col">
              <Corners />
            ...
            {/* Lead Sources */}
            <div className="relative bg-[color:var(--t-panel)] border border-[rgba(0,207,255,0.18)] p-5">
              <Corners />
              <div className="font-mono text-sm text-[rgba(0,207,255,0.5)] tracking-widest uppercase mb-4 flex items-center gap-2">
            ...
            {/* Recent Activity */}
            <div className="relative bg-[color:var(--t-panel)] border border-[rgba(0,207,255,0.18)] p-5 overflow-y-auto max-h-[220px]">
              <Corners />
              <div className="font-mono text-sm text-[rgba(0,207,255,0.5)] tracking-widest uppercase mb-4 flex items-center gap-2">
              ...
              <div className="flex flex-col gap-4 relative">
                ...
                {data.recentActivity.map((act) => (
                  <div key={act.id} className="flex gap-3 relative z-10">
                    <div className="w-[15px] h-[15px] rounded-full bg-[color:var(--t-panel)] border-2 border-[#00cfff] shrink-0 mt-0.5"></div>
                    <div>
