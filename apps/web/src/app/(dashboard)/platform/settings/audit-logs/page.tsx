  ...
  const logs = [
    {
      date: "Aug 12 14:20",
      user: "Aleena",
      action: "Added knowledge source",
      resource: "Refund Policy.pdf",
      ip: "192.168.1.1",
      status: "Success",
    },
    {
    ...
    },
    {
      date: "Aug 12 12:10",
      user: "Aleena",
      action: "Connected Gmail mailbox",
      resource: "sales@acme.inc",
      ip: "192.168.1.1",
      status: "Success",
    },
    {
      date: "Aug 12 11:40",
      user: "Sarah",
      action: "Activated sequence",
      resource: "Q3 Outbound",
      ip: "172.16.0.4",
      status: "Success",
    },
  ];
