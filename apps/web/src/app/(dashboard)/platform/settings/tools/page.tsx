        ...
        JSON.stringify(
          {
            ...
            data: {
              ticket_id: "ZD-8842",
              url: "https://zendesk.com/tickets/8842",
            },
          },
          null,
          2,
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <Button
          ...
          className="bg-gradient-to-r from-[#D122E3] to-[#00F2FE] hover:opacity-90 text-white border-0 shadow-lg"
        >
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {tools.map((tool) => (
          <Card
            key={tool.id}
            className="bg-[#1E1E2E] border-[#3F3F5A] text-white shadow-lg transition-all hover:border-[#00F2FE]"
          >
              ...
              <div className="flex items-center justify-between pt-2 border-t border-[#3F3F5A]">
                <div className="flex items-center gap-2 text-sm">
                  {tool.requiresConfirmation ? (
                    <span className="text-amber-400 flex items-center">
                      <ShieldAlert className="w-4 h-4 mr-1" /> Requires
                      Confirmation
                    </span>
                  ) : (
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    className="border-[#3F3F5A] text-[#00F2FE] hover:text-[#D122E3] hover:bg-[#3F3F5A] h-8"
                  >
                    Test
                  </Button>
                  <Button
        ...
        <div className="absolute inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#1E1E2E] border border-[#3F3F5A] rounded-xl w-full max-w-2xl p-6 shadow-2xl overflow-y-auto max-h-[90vh]">
            ...
            <div className="mt-8 flex justify-end gap-3 pt-4 border-t border-[#3F3F5A]">
              ...
              <Button
                onClick={() => setIsAddModalOpen(false)}
                className="bg-gradient-to-r from-[#D122E3] to-[#00F2FE] hover:opacity-90 text-white border-0"
              >
                Register Tool
              </Button>
            </div>
