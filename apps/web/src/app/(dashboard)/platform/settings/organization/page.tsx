      ...
      <SettingSection title="Organization" icon={Building}>
        ...
        >
          ...
          <Input
            ...
            onChange={(e: any) => updateOrganization({ name: e.target.value })}
          />
          {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
          <Input
            label="Website"
          ...
          <Input
            ...
            onChange={(e: any) =>
              updateOrganization({ industry: e.target.value })
            }
          />
          <Select
            label="Timezone"
            ...
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            onChange={(e: any) =>
              updateOrganization({ timezone: e.target.value })
            }
            options={TIMEZONES}
          />
          <Select
            ...
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            onChange={(e: any) =>
              updateOrganization({ language: e.target.value })
            }
            options={[
