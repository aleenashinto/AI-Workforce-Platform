  ...
  const dummyDocs = [
    {
      ...
      source_name: "Product Manual.pdf",
      sync_status: "ready",
    ...
    },
    {
      ...
      source_name: "https://docs.company.com",
      sync_status: "ready",
          ...
          <table className="w-full text-sm text-left">
            ...
            <tbody>
              {dummyDocs.map((doc) => (
                <tr
                  key={doc.id}
                  className="border-b border-[#3F3F5A]/50 hover:bg-[#3F3F5A]/30 transition-colors"
                >
                    ...
                    <Badge
                      ...
                      className={
                        doc.sync_status === "ready"
                          ...
                          : doc.sync_status === "processing"
                            ? "border-amber-500/50 text-amber-400 bg-amber-500/10"
                            : "border-rose-500/50 text-rose-400 bg-rose-500/10"
                      }
                    >
                      {doc.sync_status.charAt(0).toUpperCase() +
