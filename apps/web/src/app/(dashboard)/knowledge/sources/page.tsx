  ...
  const fetchSources = async () => {
    try {
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/v1/sources?org_id=${currentOrgId}`,
        {
          credentials: "include",
  ...
  const handleAddSource = async () => {
    try {
      ...
      const payload = {
        ...
        type: sourceType,
        name:
          sourceName || (sourceType === "file" ? "Uploaded File" : sourceUrl),
        config:
          sourceType === "file"
            ? { filename: sourceName, contentType: "application/pdf" }
            : { url: sourceUrl },
      };
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button
          ...
          className="bg-gradient-to-r from-[#D122E3] to-[#00F2FE] hover:opacity-90 text-white shadow-lg border-0"
        >
          ...
          <div className="bg-[#1E1E2E] border border-[#3F3F5A] rounded-xl w-full max-w-md p-6 shadow-2xl">
            ...
            <div className="space-y-4">
              ...
              <Button
                ...
                className="w-full bg-gradient-to-r from-[#D122E3] to-[#00F2FE] hover:opacity-90 text-white mt-4 border-0"
              >
                Add Source
              </Button>
            </div>
