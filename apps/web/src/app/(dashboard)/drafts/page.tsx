  ...
  return (
    <div className="p-8 h-full overflow-y-auto">
      ...
      <div className="grid grid-cols-4 gap-4 mb-8 font-mono">
        <div className="bg-[#0a1628] border border-[#00ff88]/20 p-4 rounded-lg flex items-center gap-4">
        ...
        <div className="bg-[#0a1628] border border-orange-500/20 p-4 rounded-lg flex items-center gap-4">
        ...
        <div className="bg-[#0a1628] border border-green-500/20 p-4 rounded-lg flex items-center gap-4">
        ...
        <div className="bg-[#0a1628] border border-blue-500/20 p-4 rounded-lg flex items-center gap-4">
      ...
      <div className="bg-[#0a1628] border border-[#00ff88]/20 rounded-lg overflow-hidden flex flex-col">
                ...
                drafts.map((draft) => (
                  ...
                  >
                    <td className="p-4 text-center">
                      <div className="w-8 h-8 rounded bg-[#040810] border border-[#00ff88]/20 flex items-center justify-center">
