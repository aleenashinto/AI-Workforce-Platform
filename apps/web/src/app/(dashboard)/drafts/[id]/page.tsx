    ...
    <div className="h-full flex flex-col bg-[color:var(--t-bg)]">
      ...
      <div className="flex-1 overflow-hidden flex">
        ...
        <div className="flex-1 overflow-y-auto p-8 flex flex-col gap-6">
          <div className="bg-[color:var(--t-panel)] border border-[#00ff88]/20 rounded-lg p-6 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1 flex-1 min-h-[400px]">
              <div className="flex justify-between items-center mb-2">
                ...
                <div className="flex gap-2 relative">
                  ...
                  {showAiInput && (
                    <div className="absolute right-0 top-full mt-2 w-72 bg-[color:var(--t-bg)] border border-[#00ff88]/30 rounded-lg shadow-xl shadow-[#00ff88]/5 p-3 z-10 flex flex-col gap-2">
                      ...
                      <textarea
                        ...
                        className="bg-[color:var(--t-panel)] border border-[#00ff88]/20 rounded text-sm text-white p-2 h-20 resize-none focus:outline-none focus:border-[#00ff88]/50"
                      />
                      <div className="flex justify-end gap-2">
                        ...
                        <button
                          ...
                          className="bg-[#00ff88] text-[color:var(--t-bg)] px-3 py-1 rounded font-bold text-xs disabled:opacity-50 flex items-center gap-1"
                        >
                          {aiLoading ? (
                            "Thinking..."
                          ) : (
              ...
              <textarea
                ...
                className="flex-1 w-full bg-[color:var(--t-bg)] border border-[#00ff88]/10 rounded-md p-4 text-gray-200 text-base leading-relaxed resize-none focus:outline-none focus:border-[#00ff88]/30"
        ...
        {showVersions && (
          <div className="w-80 border-l border-[#00ff88]/20 bg-[color:var(--t-panel)] flex flex-col">
