...
></script>`;
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-white">Widget Configuration</h1>
        <p className="text-muted-foreground mt-1">Customize and install the chat widget on your website.</p>
      </div>
        ...
        <div className="space-y-6">
          <Card className="bg-[#2A2A3C] border-[#3F3F5A] text-white">
            <CardHeader>
              ...
              <CardDescription className="text-gray-400">Match the widget to your brand.</CardDescription>
            </CardHeader>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <Button 
                    ...
                    className={position === 'bottom-left' ? 'bg-indigo-600 hover:bg-indigo-700' : 'border-[#3F3F5A] hover:bg-[#3F3F5A]'}
                  ...
                  <Button 
                    ...
                    className={position === 'bottom-right' ? 'bg-indigo-600 hover:bg-indigo-700' : 'border-[#3F3F5A] hover:bg-[#3F3F5A]'}
          ...
          <Card className="bg-[#2A2A3C] border-[#3F3F5A] text-white">
            <CardHeader>
              ...
              <CardDescription className="text-gray-400">Paste this before the closing &lt;/body&gt; tag.</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <div>
          <Card className="bg-[#2A2A3C] border-[#3F3F5A] text-white h-full min-h-[500px] relative overflow-hidden flex flex-col">
            <CardHeader>
              ...
              <CardDescription className="text-gray-400">Interact with your configured widget.</CardDescription>
            </CardHeader>
            <CardContent className="flex-1 bg-[#1E1E2E] m-4 mt-0 rounded-lg border border-[#3F3F5A] relative">
              ...
              <div className="absolute inset-0 z-10 pointer-events-none">
                ...
                <div className="absolute bottom-6 right-6 w-[60px] h-[60px] rounded-full flex items-center justify-center shadow-lg pointer-events-auto" style={{ backgroundColor: color, [position === 'bottom-left' ? 'left' : 'right']: '24px', right: position === 'bottom-right' ? '24px' : 'auto' }}>
