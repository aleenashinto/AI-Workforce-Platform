  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-3">
          <Button
            ...
            className="bg-[#00ff88] hover:bg-[#00ff88]/80 text-black h-10 px-6 font-bold uppercase tracking-wider"
          >
      ...
      <div className="flex-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {loading ? (
          <div className="text-[#00ff88] animate-pulse p-4">
            Loading research history...
          </div>
        ) : history.length === 0 ? (
          <div className="col-span-full bg-[color:var(--t-panel)] border border-dashed border-[#00ff88]/30 rounded-xl p-8 flex flex-col items-center justify-center text-center">
            <Search className="w-12 h-12 text-[#00ff88]/50 mb-4" />
            ...
            <Button
              onClick={() => setShowCreate(true)}
              className="bg-transparent border border-[#00ff88] text-[#00ff88] hover:bg-[#00ff88]/10 font-bold uppercase"
            >
              Start New Research
            </Button>
          </div>
          ...
          history.map((item) => (
            <div
              key={item.id}
              className="bg-[color:var(--t-panel)] border border-[rgba(0,255,136,0.2)] hover:border-[#00ff88]/50 transition-colors rounded-xl p-5 flex flex-col relative group"
            >
              ...
              <div className="flex items-center justify-between mt-auto pt-4 border-t border-white/5">
                ...
                <Button
                  ...
                  variant="ghost"
                  size="sm"
                  className="text-[#00ff88] hover:bg-[#00ff88]/10 p-0 h-auto font-bold uppercase tracking-wider text-xs flex items-center"
                >
      ...
      {showCreate && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="w-[600px] bg-[color:var(--t-bg2)] border border-[#00ff88]/30 rounded-2xl shadow-2xl overflow-hidden flex flex-col">
            <div className="p-6 border-b border-[#00ff88]/20 bg-[color:var(--t-panel)]">
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-black/40 border border-white/10 rounded-lg p-3 text-white outline-none focus:border-[#00ff88] text-sm"
                />
              </div>
              <div>
                <label className="block text-xs uppercase text-gray-400 font-bold mb-1">
                ...
                <textarea
                  ...
                  className="w-full h-24 bg-black/40 border border-white/10 rounded-lg p-3 text-white outline-none focus:border-[#00ff88] text-sm resize-none"
                />
              </div>
              <div>
                <label className="block text-xs uppercase text-gray-400 font-bold mb-1">
            ...
            <div className="p-6 border-t border-[#00ff88]/20 bg-[color:var(--t-panel)] flex justify-end gap-3">
              <Button
                variant="outline"
              ...
              <Button
                ...
                className="bg-[#00ff88] hover:bg-[#00ff88]/80 text-black font-bold uppercase"
              >
