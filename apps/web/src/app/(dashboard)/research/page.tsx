    ...
    >
      ...
      <div className="flex-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {loading ? (
          ...
          <div className="col-span-full bg-[#0a1628] border border-dashed border-[#00ff88]/30 rounded-xl p-8 flex flex-col items-center justify-center text-center">
          ...
          history.map((item) => (
            <div
              key={item.id}
              className="bg-[#0a1628] border border-[rgba(0,255,136,0.2)] hover:border-[#00ff88]/50 transition-colors rounded-xl p-5 flex flex-col relative group"
            >
      ...
      {showCreate && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="w-[600px] bg-[#070e1a] border border-[#00ff88]/30 rounded-2xl shadow-2xl overflow-hidden flex flex-col">
            <div className="p-6 border-b border-[#00ff88]/20 bg-[#0a1628]">
            ...
            <div className="p-6 border-t border-[#00ff88]/20 bg-[#0a1628] flex justify-end gap-3">
              <Button
                variant="outline"
