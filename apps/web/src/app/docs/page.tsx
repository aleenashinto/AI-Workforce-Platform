...
<script src="https://cdn.aiworkforce.com/widget.js" data-org-id="YOUR_ORG_ID"></script>`}
          ...
          <div className="space-y-6">
            <div className="border border-[#3F3F5A] bg-[#1E1E2E] rounded-lg overflow-hidden shadow-lg">
              <div className="bg-[#2A2A3C] p-4 flex items-center gap-4 cursor-pointer hover:bg-[#3F3F5A]/50 transition-colors">
                <span className="bg-blue-600/20 border border-blue-500/50 text-blue-400 px-2 py-1 rounded font-bold text-sm min-w-[60px] text-center shadow-[0_0_10px_rgba(59,130,246,0.2)]">
                  GET
                </span>
            ...
            <div className="border border-[#3F3F5A] bg-[#1E1E2E] rounded-lg overflow-hidden shadow-lg">
              <div className="bg-[#2A2A3C] p-4 flex items-center gap-4 cursor-pointer hover:bg-[#3F3F5A]/50 transition-colors">
                <span className="bg-emerald-600/20 border border-emerald-500/50 text-emerald-400 px-2 py-1 rounded font-bold text-sm min-w-[60px] text-center shadow-[0_0_10px_rgba(16,185,129,0.2)]">
                  POST
                </span>
                <span className="font-mono font-semibold text-gray-200">
                  /chat/conversations
  ...
  "content": "I need help with my account."
            ...
            <div className="border border-[#3F3F5A] bg-[#1E1E2E] rounded-lg overflow-hidden shadow-lg">
              <div className="bg-[#2A2A3C] p-4 flex items-center gap-4 cursor-pointer hover:bg-[#3F3F5A]/50 transition-colors">
                <span className="bg-amber-600/20 border border-amber-500/50 text-amber-400 px-2 py-1 rounded font-bold text-sm min-w-[60px] text-center shadow-[0_0_10px_rgba(245,158,11,0.2)]">
                  PATCH
                </span>
                <span className="font-mono font-semibold text-gray-200">
                  /leads/{"{id}"}
