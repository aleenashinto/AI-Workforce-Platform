...
async function seed() {
  ...
  if (!org) {
    console.log(
      "No organization found. Creating a development organization...",
    );
    [org] = await db
  ...
  if (isReset) {
    ...
    const demoUsers = await db
      .select()
      .from(end_users)
      .where(eq(end_users.org_id, org_id));
    const demoUserIds = demoUsers
      .filter((u) => (u.metadata as any)?.is_demo)
      .map((u) => u.id);
    ...
    if (demoUserIds.length > 0) {
      ...
      for (const uid of demoUserIds) {
        const userConvs = await db
          .select()
          .from(conversations)
          .where(eq(conversations.visitor_id, uid));
  ...
  const scenarios = [
    {
      ...
      msgs: [
        {
          u: "Hi, I placed my order three days ago. Can you tell me where it is?",
          a: "I'd be happy to check that for you. I see your order #12345 is currently in transit.",
          u: "Can you tell me when it will arrive?",
          a: "The current estimated delivery date is tomorrow.",
          ai: true,
        },
      ],
    },
    {
      ...
      msgs: [
        {
          u: "I need a refund for my last purchase.",
          a: "I can help with that. Could you provide the reason for the refund?",
          u: "It arrived damaged.",
          a: "I'm sorry to hear that. I have initiated the refund process.",
          ai: true,
        },
      ],
    },
    {
      ...
      msgs: [
        {
          u: "My payment was charged but my order wasn't created.",
          a: "Let me check the payment status and order record for you.",
          u: "Please do, it was for $50.",
          a: "I found the charge. I am manually creating the order now. You will receive a confirmation shortly.",
          ai: false,
        },
      ],
    },
    {
      ...
      msgs: [
        {
          u: "Does the pro version include API access?",
          a: "Yes, the Pro version includes full API access with a limit of 10k requests per day.",
          u: "Great, thanks!",
    ...
    },
    {
      ...
      msgs: [
        {
          u: "I received the wrong product. How can I return it?",
          a: "I'm sorry about that. I'll help you start the return process. Please provide your order number.",
          u: "Order #9876",
          a: "Thank you. I have emailed you the return label.",
          ai: false,
        },
      ],
    },
    {
      ...
      msgs: [
        {
          u: "I can't log into my account.",
          a: "I can help with that. Are you seeing an error message?",
          u: "It says invalid password.",
          a: "I have sent a password reset link to your email.",
          ai: true,
        },
      ],
    },
    {
      ...
      msgs: [
        {
          u: "My package is late.",
          a: "I apologize for the delay. Let me check the tracking.",
          u: "It's been stuck in transit for 3 days.",
          a: "I see it. It is currently at the local distribution center and should be delivered today.",
          ai: false,
        },
      ],
    },
    {
      ...
      msgs: [
        {
          u: "How do I upgrade my subscription?",
          a: "You can upgrade your subscription from the billing page in your account settings.",
          u: "Done, thanks.",
          a: "Thank you for upgrading!",
          ai: true,
        },
      ],
    },
    {
      ...
      msgs: [
        {
          u: "I want to cancel my subscription.",
          a: "I can assist with that. May I ask why you are cancelling?",
          u: "I don't need it anymore.",
          a: "I understand. I have processed the cancellation.",
          ai: false,
        },
      ],
    },
      ...
      msgs: [
        {
          ...
          a: "I'm sorry to hear that. What version of the app are you using?",
          u: "Version 2.0",
          a: "Please try updating to the latest version, 2.1.",
          ai: false,
        },
      ],
    },
    {
      ...
      msgs: [
        {
          u: "The service I received was terrible.",
          a: "I sincerely apologize for your experience. I am escalating this to our support manager.",
          u: "Good.",
          a: "A manager will reach out to you shortly.",
          ai: false,
          escalate: true,
        },
      ],
    },
    {
      ...
      msgs: [
        {
          u: "What are your business hours?",
          a: "Our business hours are 9 AM to 5 PM EST, Monday through Friday.",
          u: "Thanks",
          a: "You're welcome!",
          ai: true,
        },
  ...
  for (let i = 0; i < 50; i++) {
    ...
    if (
      status === "escalated" ||
      (!scenario.msgs[0].ai && status !== "resolved")
    ) {
    ...
    const tags = [
      scenario.type.split(" ")[0].toLowerCase(),
      random(["vip", "returning", "urgent", "standard"]),
    ];
    const csat_score =
      status === "resolved"
        ? Math.random() > 0.3
          ? randomInt(3, 5).toString()
          : null
        : null;
    ...
    const msgData = [
      ...
      {
        role: sequence.ai ? "assistant" : "agent",
        content: sequence.a2 || "Is there anything else I can help you with?",
      },
    ];
    ...
    if (scenario.msgs[0].escalate || status === "escalated") {
      ...
      msgData.push({
        role: "agent",
        content: "Hi, I am taking over this conversation to assist you.",
      });
    ...
    for (const m of msgData) {
      ...
      const confidence =
        m.role === "assistant" ? randomInt(70, 99) / 100 : undefined;
